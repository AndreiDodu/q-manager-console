...
@Component
public class CommandQuestionCreate implements Command {

	private static final String COMMAND = "questionCreate";
	...
	public void execute(Map<Integer, String> commands) {
		System.out.println("==> Question creation selected");
		...
		Question group = this.getService().create(groupInsert);
