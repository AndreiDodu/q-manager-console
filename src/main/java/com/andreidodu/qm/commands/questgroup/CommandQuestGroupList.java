...
@Component
public class CommandQuestGroupList extends CommandListAssociationCommon<QuestionnaireGroup> implements Command {

	private static final String COMMAND = "questionnairegroupList";
