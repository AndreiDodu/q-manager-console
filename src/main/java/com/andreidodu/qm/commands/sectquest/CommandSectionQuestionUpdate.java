...
@Component
public class CommandSectionQuestionUpdate extends CommandUpdateAssociationCommon<SectionQuestion> implements Command {

	private static final String COMMAND = "sectionquestionUpdate";
