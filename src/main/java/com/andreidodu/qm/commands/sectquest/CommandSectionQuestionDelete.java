...
@Component
public class CommandSectionQuestionDelete extends CommandDeleteAssociationCommon<SectionQuestion> implements Command {

	private static final String COMMAND = "sectionquestionDelete";
