...
@Component
public class CommandGroupSectionSingle extends CommandSingleAssociationCommon<GroupSection> implements Command {

	protected static final String COMMAND = "groupsectionSingle";
